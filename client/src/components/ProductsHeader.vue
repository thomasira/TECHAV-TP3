<template>
<header class='flex gap-3 justify-center'>
    <div>
        <h2 class='text-s font-bold'>Consult and modify your products</h2>
  ...
  <AddProduct v-if="showForm" :types="types" :toggle="toggleForm" :addInv="addInv" :findType="findType" :showDialog="showDialog"/>
</template>
...
export default {
  props: ['types', 'addInv', 'findType', 'showDialog'],
  data () {
    return {
      btnText: 'add product',
